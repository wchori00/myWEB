...
<option value="02" ${phone eq '02' ? "selected='selected'":'null'} >02</option>
<option value="010" ${phone eq '010' ? "selected='selected'":'null'} >010</option>
<option value="011" ${phone eq '011' ? "selected='selected'":'null'} >011</option>
<option value="016" ${phone eq '016' ? "selected='selected'":'null'} >016</option>
<option value="017" ${phone eq '017' ? "selected='selected'":'null'} >017</option>
<option value="018" ${phone eq '018' ? "selected='selected'":'null'} >018</option>
<option value="019" ${phone eq '019' ? "selected='selected'":'null'} >019</option>
</select>&nbsp;-&nbsp;
